...
const Sidebar = ({ activeTab, onSelect }) => {
  ...
  backdrop-blur-sm border-r border-gray-200 p-4 
  text-gray-800 dark:text-gray-200">
      ...
      <div className="space-y-2">
        <button
          onClick={toggleTheme}
          className="flex items-center gap-3 w-full px-4 py-2 rounded-lg text-left transition-colors duration-200 text-gray-700 hover:bg-blue-600 hover:text-white dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
        >
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-4 py-2 rounded-lg text-left transition-colors duration-200 text-red-600 hover:bg-red-100 dark:hover:bg-red-900"
        >
          <LogOut size={18} />
          <span>Logout</span>
        </button>
